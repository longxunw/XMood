...
object ScheduleDataGet {
    ...
    val scheduleList = arrayListOf<LessonItem>(
        LessonItem(
            0, "计算理论基础1", "田家炳教育书院236", 1, 1,
            Str2Long("08:00", "HH:mm"),
            Str2Long("09:40", "HH:mm")
        ),
        LessonItem(
            1, "计算理论基础2", "田家炳教育书院236", 2, 2,
            Str2Long("10:00", "HH:mm"),
            Str2Long("11:40", "HH:mm")
        ),
        LessonItem(
            2, "计算理论基础5", "田家炳教育书院236", 5, 3,
            Str2Long("08:00", "HH:mm"),
            Str2Long("10:45", "HH:mm")
        ),
        LessonItem(
            3, "计算理论基础3上午", "田家炳教育书院236", 3, 4,
            Str2Long("10:00", "HH:mm"),
            Str2Long("11:40", "HH:mm")
        ),
        LessonItem(
            4, "计算理论基础1下午", "田家炳教育书院236", 1, 4,
            Str2Long("10:00", "HH:mm"),
            Str2Long("11:40", "HH:mm")
        ),
        LessonItem(
            5, "计算理论基础3下午", "田家炳教育书院236", 3, 4,
